...
try {
    ...
    $stmt_ranking = $db->prepare("SELECT * FROM dados_cnpj WHERE uf = :uf AND municipio = :city AND CAST(capital_social AS INTEGER) NOT LIKE '999%' ORDER BY capital_social DESC LIMIT 100");
